...
restrictions should be put on this set. Should I require that it be an
equivalent set that represents an \emph{mgu}? Or an idempotent mgu?
...
one should work for the other. Wand and Vallaincourt extend this work
to higher-order functions~\cite{wand2004relating}. My thought was I
could use this to find my interleaving backtracking monad:
...
\noindent I've done a bunch of this. Partly it's doing the obvious components.
