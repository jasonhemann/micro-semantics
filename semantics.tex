...
\end{tabu}
\] 
%% \begin{tabu} to .5\textwidth{X[c] X[c]}
%% \toprule
%%  \mathcal{FV}  1                       & Column 2                                                                         \\
%% \midrule
%%  \freevarsf{\succeedv}                 & \begin{aligned}[t] x & = a                                                       \\ & =b\end{aligned}  \\
%% \bottomrule
%% \end{tabu}
...
\[
\begin{tabu}{rcll}
\sstep[g] {FreshVar} {\InCtxtsig{\freshvariableexp{x}{G}}} {\InCtxtsig{\subst{\phi}{x}{G}}} \\
%% \sstep[g] {\InCtxtsig{\freshvariableexp{x}{G}}}    {\InCtxtsig{\subst{\phi}{x}{G}}}       {\text{where $\sigma$ is fresh}}    \\
% \sstep[g] {\InCtxtsig{\syntequalexp{t}{\tprimev}}} {\InCtxtof{\succeedv}{\sigma^{'}}}     {\text{where $\sigma^{'} = \text{unify}(t,\tprimev,\sigma)$}} \\
% \sstep[g] {\InCtxtsig{\syntequalexp{t}{\tprimev}}} {\InCtxtof{\failv}{\sigma_{\emptyset}}} {\text{otherwise}}                                           \\
% \sstep[g] {\InCtxtsig{\conjunctionexp{\failv}{G}}} {\InCtxtof{\failv}{\sigma_{\emptyset}}} {}                                            \\
% \sstep[g] {\InCtxtsig{\conjunctionexp{\succeedv}{G}}} {\InCtxtsig{G}} {} 
\end{tabu}
\]
