...
\begin{tabu}{r l l l}
  ...
  \midrule
         F & \bnfrepl & .                                     &                                 \\ 
           & \alt     & g, \sigma                             &                                 \\
           & \alt     & \disjunctionexp{F}{F}                 &                                 \\
           &          &                                       &                                 \\ 
         S & \bnfrepl & \Hole                                 &                                 \\ 
           & \alt     & \disjunctionexp{\succeedv, \sigma}{S} &                                 \\
%%           & \alt     & \disjunctionexp{\failv, \sigma}{S}    &                                 \\
           &          &                                       &                                 \\ 
  \Ctxt[g] & \bnfrepl & \Hole                                 & \text{Goal Evaluation Contexts} \\
           & \alt     & \conjunctionexp{\Ctxt[g]}{G}          &                                 \\
           &          &                                       &                                 \\ 
  \Ctxt[t] & \bnfrepl & \Hole                                 & \text{Tree Evaluation Contexts} \\
           & \alt     & \disjunctionexp{\Ctxt[t]}{F}          &                                 \\
           &          &                                       &                                 \\ 
  \bottomrule
\end{tabu}
\]

I could change these rules to now just have failed unifications in
substitutions get re-written as $\bot$. We could then remove $bot$
