...
\usepackage{amsmath, listings, proof, amssymb, xspace, stmaryrd} %% amsthm
...
\newcommand{\consexp}    [2] {\mathsf{cons}\ #1\ #2}
...
%% fresh
\newcommand{\freshvariableexp}  [2] {\exists #1\ \rightarrow\ #2}

\newcommand{\relcallexp}        [2] {\mathsf{call}\ #1\ #2}
...
\newcommand{\succeedv}     {\mathsf{succeed}}
\newcommand{\failv}      {\mathsf{fail}}


%% defines
\newcommand{\defrelop}   {\mathsf{defrel}}
\newcommand{\defrelexp} [3] {\defrelop\ {#1}\ {#2}\ {#3}}
